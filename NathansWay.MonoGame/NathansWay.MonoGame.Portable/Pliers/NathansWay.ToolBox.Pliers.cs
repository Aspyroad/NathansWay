...
namespace NathansWay.MonoGame.Portable
{
    ...
    public class Pliers : ToolBase
    {
        ...
        private void DrawShip(Vector2 where)
        {
            ...
            primitiveBatch.AddVertex(where + new Vector2(0f, -ShipSizeY), Color.White);
            primitiveBatch.AddVertex(where + new Vector2(-ShipSizeX, ShipSizeY), Color.White);

            // to the right and up, into the cutout
            primitiveBatch.AddVertex(where + new Vector2(-ShipSizeX, ShipSizeY), Color.White);
            primitiveBatch.AddVertex(where + new Vector2(0f, ShipSizeY - ShipCutoutSize), Color.White);
