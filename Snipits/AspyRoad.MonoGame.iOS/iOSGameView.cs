...
#region Modification 25-06-2014
// Add an include to AspyCore
...
namespace Microsoft.Xna.Framework
{
	...
	#region Modification 255-06-2014
	// Change UIView parent to ApsyView
	partial class iOSGameView : AspyView
	#endregion
...
#region Construction/Destruction
		...
		public iOSGameView (iOSGamePlatform platform, RectangleF frame) : base (frame)
		{
			if (platform == null)
			{
