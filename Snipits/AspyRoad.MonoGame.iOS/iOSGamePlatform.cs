...
namespace Microsoft.Xna.Framework
{
	class iOSGamePlatform : GamePlatform
	{
		...
		// Comment out the following UIWindow, as we will use our predifined window.
		// The predefined window will be in our app services object.
		...
		public override void StartRunLoop ()
		{
			...
			// This is no longer monogames responsability
...
#region Notification Handling
		...
		{
			// App delegate will handle this in Nathansway.
			//GC.Collect ();
		}
