// Builder Pattern - From the Gang Of Four GOF
/*
Builder : This is an interface which is used to define all the steps to create a product.
ConcreteBuilder : This is a class which implements the Builder interface to create complex product.
...
In the below example, heres whats what :
