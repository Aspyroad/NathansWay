...
namespace NathansWay.iOS.Numeracy.Graphics
{
    ...
    public class SkMenuBackGround : NSObject
    {
        ...
        public static void DrawCanvasMain(NSShadow colorTextNumbersOuterShadow, RectangleF menuLogoFrame)
        {
            ...
            RectangleF textNumberDisplayRect = new RectangleF(230.0f, 22.0f, 594.0f, 128.0f);
            {
                ...
                context.SaveState();
                context.SetShadowWithColor(colorTextNumbersOuterShadow.ShadowOffset, colorTextNumbersOuterShadow.ShadowBlurRadius, colorTextNumbersOuterShadow.ShadowColor.CGColor);
                colorTextNathansWay.SetFill();
