...
namespace NathansWay.iOS.Numeracy.Controls
{
    ...
    public partial class vcNumberTextGUI : NumberTextBoxBase
    {
        ...
        public vcNumberTextGUI (IntPtr h) : base (h)
        {
            Initialize();
        }

        [Export("initWithCoder:")]
        public vcNumberTextGUI (NSCoder coder) : base(coder)
        {
            Initialize();
        }

        public vcNumberTextGUI()
        {
            Initialize();
        }
