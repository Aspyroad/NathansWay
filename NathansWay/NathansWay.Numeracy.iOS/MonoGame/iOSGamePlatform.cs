...
namespace Microsoft.Xna.Framework
{
    class iOSGamePlatform : GamePlatform
    {
        ...
        private AspyWindow _mainWindow;
        ...
        public iOSGamePlatform(Game game) : base(game)
        {
            ...
            _mainWindow = (AspyWindow)UIApplication.SharedApplication.Windows [0];
            ...
            //UIApplication.SharedApplication.Windows[0].RootViewController = _viewController;
            //UIApplication.SharedApplication.Windows[0].Add (_viewController.View);
