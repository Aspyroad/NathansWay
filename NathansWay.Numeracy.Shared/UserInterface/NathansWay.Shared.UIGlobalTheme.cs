...
namespace NathansWay.Shared
{
	public class UIGlobalTheme : IUITheme
	{
		...
		public UIGlobalTheme()
		{
			...
			ButtonNormalTitleColor = new Lazy<G__Color> (() => new G__Color(255.0f, 255.0f, 255.0f, 240.0f)); // Black
			...
			ViewBGColor = new Lazy<G__Color> (() => new G__Color(120.0f, 160.0f, 196.0f, 255.0f)); // Orange
			...
			// UITableVIew
			ViewTableBGColor = new Lazy<G__Color> (() => new G__Color(255.0f, 255.0f, 255.0f, 230.0f)); // 
			...
			ViewCellSelectedColor = new Lazy<G__Color> (() => new G__Color(120.0f, 160.0f, 196.0f, 50.0f)); // 
			ViewCellBGColor = new Lazy<G__Color> (() => new G__Color(120.0f, 160.0f, 196.0f, 50.0f)); // 
