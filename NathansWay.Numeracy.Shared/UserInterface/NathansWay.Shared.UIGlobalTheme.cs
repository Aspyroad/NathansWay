...
namespace NathansWay.Shared
{
	public class UIGlobalTheme : IUITheme
	{
		...
		public UIGlobalTheme()
		{
			...
			ViewBGColor = new Lazy<G__Color> (() => new G__Color(255.0f, 140.0f, 0.0f, 255.0f)); // Orange
			ViewBGColorTransition = new Lazy<G__Color> (() => new G__Color(255.0f, 130.0f, 0.0f, 255.0f)); // Orange less alpha
            ...
            // UIPickerView
            PkViewBGColor = new Lazy<G__Color> (() => new G__Color(255.0f, 255.0f, 255.0f, 30.0f)); // Black
