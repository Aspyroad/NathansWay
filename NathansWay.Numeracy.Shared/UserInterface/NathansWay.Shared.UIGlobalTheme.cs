...
namespace NathansWay.Shared
{
	public class UIGlobalTheme : IUITheme
	{
		...
		public UIGlobalTheme()
		{
			...
			ViewBGColor = new Lazy<G__Color> (() => new G__Color(230.0f, 140.0f, 0.0f, 255.0f)); // Orange
            ...
            ReadOnlyBorderColor = new Lazy<G__Color> (() => new G__Color(100.0f, 100.0f, 0.0f, 255.0f)); // Black
            SelectedBGColor = new Lazy<G__Color> (() => new G__Color(255.0f, 255.0f, 255.0f, 255.0f)); // White
            SelectedTextColor = new Lazy<G__Color> (() => new G__Color(0.0f, 0.0f, 0.0f, 255.0f)); // Black
