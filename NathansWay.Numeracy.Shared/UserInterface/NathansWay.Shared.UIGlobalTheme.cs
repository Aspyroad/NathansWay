...
namespace NathansWay.Shared
{
	public class UIGlobalTheme : IUITheme
	{
		...
		public UIGlobalTheme()
		{
			...
			// UIButton
			ButtonNormalBGColor = new Lazy<G__Color> (() => new G__Color(80.0f, 200.0f, 30.0f, 255.0f)); // Black
			ButtonNormalBGColorTransition = new Lazy<G__Color> (() => new G__Color(30.0f, 100.0f, 255.0f, 100.0f)); // Black
